...
WEIGHTS = {
    ...
    "jockey":   0.22,  # 騎手勝率（rho=0.49、逆因果割引あり）
    "prep":     0.18,  # 前走クラス×着順（rho=0.21）
    "ti":       0.18,  # タイム指数ピーク（rho=0.23）
    "interval": 0.04,  # 間隔・成長補正（rho=0.11、非有意だが残す）
    "ur":       0.03,  # 上り3F指数（rho=0.12、非有意だが残す）
...
<table class="summary-table">
  <thead>
    <tr>
      ...
      <th>総合スコア</th>
      <th>AIモデル<br>35%</th><th>騎手<br>22%</th><th>前走<br>クラス18%</th><th>TI<br>18%</th><th>間隔<br>4%</th><th>上り3F<br>3%</th>
    </tr>
  </thead>
...
<table class="weight-table">
  ...
  <tbody>
    ...
    <tr><td>騎手（全体勝率）</td><td>22%</td><td>全指標中最強の相関（rho=0.49）。逆因果（強い馬に良い騎手）を考慮し割引</td></tr>
    <tr><td>前走クラス×着順</td><td>18%</td><td>G1前走1着:33.3% / G3前走1着:16.2% / G2前走1着:4.0%（rho=0.21）</td></tr>
    <tr><td>タイム指数ピーク</td><td>18%</td><td>68以上:20.0% / 63-68:3.8% / 58-63:8.0%（rho=0.23）</td></tr>
    <tr><td>間隔・成長補正</td><td>4%</td><td>9-12週:13.9% / 13週以上:11.5% / 5-6週:1.8%（rho=0.11、参考程度）</td></tr>
    <tr><td>上り3F指数</td><td>3%</td><td>60-65:8.3% / 55-60:5.6% / 65以上:2.8%（rho=0.12、参考程度）</td></tr>
  </tbody>
</table>
